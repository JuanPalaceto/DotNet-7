...
try
{
    ...
    // wrap the file stream in an XML writer helper and automatically indendt nested elements
...
finally
{
    ...
    if (xmlFileStream != null)
    {
        ...
        WriteLine("The file stream's unmanaged resources have beed disposed.");
    }
}
...
/* PRO TIP: Usar using en vez de llamar Dispose() manualmente, a menos que se requiera un mayor control */

SectionTitle("Compressing streams");
Compress(alrorithm: "gzip");
Compress(alrorithm: "brotli");

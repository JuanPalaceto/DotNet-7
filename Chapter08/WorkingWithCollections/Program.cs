...
/* Alternative syntax that is converted by the compiler into the three Add mehtod calls above
 * List<string> cities = new()
 * { "London", "Paris", "Milan" }; */

/* Alternative syntax that passes on array of string values to AddRange method
 * List<string> cities = new();
...
OutputPQ("Curren queue for vaccination:", vaccine.UnorderedItems);

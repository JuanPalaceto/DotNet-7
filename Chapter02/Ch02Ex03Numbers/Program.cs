using System.Runtime.InteropServices; // Marshal, para obtener el tamaño en bytes de Half (presumiblemente de otros tipos también)

string rowSeparator = new string('-', count: 74); // Generar un string repetido varias veces
...
WriteLine($"Half    {Marshal.SizeOf<Half>(),-4} {Half.MinValue,30} {Half.MaxValue,30}");
WriteLine(rowSeparator);
...
public class Person : object, IComparable<Person?>
{
    ...
    // delegate field
    // con la palabra event, nos aseguramos que solo se podrán usar los operadores += y -= adelegato
    ...
    public void Poke()
    {
        ...
        if (AngerLevel >= 3)
        {
            ...
            // Antigua forma de comprobar si un objeto es null antes de llamarlo < C# 6.0
            //if (Shout != null)
            //{
            //    // ...then call the delegate
    ...
    public int CompareTo(Person? other)
    {
        ...
        if ((this is not null) && (other is not null))
        {
            if ((Name is not null) && (other.Name is not null))
            {
                ...
                // use the strting implementation of CompareTo
            ...
            {
                position = 0; // this Person and other Persona are the same position
            }
        }
        ...
        {
            position = 0; // this Person and other Person are the same position
        }
